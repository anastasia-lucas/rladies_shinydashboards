...
Hint: the code to create a validation function is below. We could then need to place our validation function ```v()``` within each ```render*()``` function that we want it to effect.
